...
{
    //Trong lập trình C# 1 chỉ cho phép đơn kế thừa - 1 con chỉ có 1 cha
    //Cho phép implement nhiều Interface
    class ServiceStudent : IServiceStudent
    {
        //Khai báo biến toàn cục ở trên cùng
        private string _input;
        private List<Student> _lstSinhViens;
        private Student _sinhVien;
        public ServiceStudent()
        {
            _lstSinhViens = new List<Student>();
        ...
        public void addSinhVien()
        {
            do
            {
                ...
                {
                    _sinhVien = new Student();//Phải khởi tạo đối tượng mới dùng được
        ...
        public void findSinhVien()
        {
            ...
            Console.WriteLine("Mời bạn nhập mã sinh viên: ");
            _input = Console.ReadLine();
            _lstSinhViens.Where(c => c.Id == Convert.ToInt32(_input)).FirstOrDefault().inRaManHinh1();
        }
