    ...
    class Program
    {
       ...
       */
        static void Main(string[] args)
        {
             ...
             */
            PolyClassGeneric<string> classGeneric = new PolyClassGeneric<string>();
            classGeneric.Temp = "FPOLY";
            ...
            {
                Console.WriteLine($"Mời bạn nhập index{i}: ");
                polyGeneric.addValueByIndex(i,Console.ReadLine());
            }
